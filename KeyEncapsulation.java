...
public class KeyEncapsulation {
     ...
     */
    public class KeyEncapsulationDetails {
    ...
    public KeyEncapsulationDetails get() {
        return alg_details_;
    } 
    ...
    public long getCipherTextLength(){
        return alg_details_.length_ciphertext;
    }
    public String getNistLevel(){
        return  String.valueOf(alg_details_.claimed_nist_level) ;
    }
